...
const Banner = () => {
    return (
        <div className="mx-8 relative -top-20 -z-20">
            ...
            <div className="rounded-2xl p-3 bg-[#FFFFFF4D] border border-gray-200 w-[900px] absolute top-1/2 left-1/2 transform -translate-x-1/2 translate-y-32 z-50">
                <div>
